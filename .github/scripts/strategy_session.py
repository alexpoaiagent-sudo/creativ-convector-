...
PROJECTS = {
    ...
    "Личное развитие": ["развитие", "обучение", "навык", "книга", "курс", "учеба", "рост", "цель"],
    "Саморефлексия": ["рефлексия", "чувствую", "думаю", "размышление", "душа", "эмоция", "переживание", "осознание"],
